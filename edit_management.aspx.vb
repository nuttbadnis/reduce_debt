    ...
    Private Sub SaveData(ByVal SaveOrNext As String)
        ...
        Try
            ...
            If SaveOrNext = "Next" Then
                ClientScript.RegisterStartupScript(Page.GetType, "success_insert", "AlertSuccess('อัพเดทข้อมูลได้สำเร็จ', function(){ window.location = 'edit_Summary.aspx?request_id=" & Request.QueryString("request_id") & "'; });", True)
            Else
