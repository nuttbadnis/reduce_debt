<%@ Page MaintainScrollPositionOnPostback="true" Language="VB" MasterPageFile="~/MasterPageMenu.master" AutoEventWireup="true" CodeFile="project_upload.aspx.vb" Inherits="project_upload" EnableEventValidation="false" %>
...
<style>
  ...
  .datepicker{
    ...
    <ol class="breadcrumb headingbar">
        ...
        <li class="breadcrumb-item"><a href="Summary.aspx?menu=create">Summary (Upload)</a></li>
    </ol>
                 ...
                 <div class="col-md-12">
                    <div class="form-inline form-group">
                        ...
                        <div class="input-group col-7">
                            ...
                            <ContentTemplate>
                                <asp:FileUpload ID="FileUploadProject" runat="server"  ViewStateMode="Enabled" />
            ...
            <div class="row" id="div_OpenProject" runat="server">
                 <div class="col-md-12">
                    <div class="form-inline form-group">
                        <asp:Label ID="Label25" runat="server" Text="Upload File Project:" Font-Bold="True" class="col-2"></asp:Label> 
                        <div class="input-group col-7">
                            <asp:HyperLink ID="LinkFileProject" runat="server">ไฟล์โปรเจคแนบ</asp:HyperLink><br />
                        </div>
                    </div>
                 </div>
                 <div class="col-md-12">
                    <div class="form-inline form-group">
                        <div class="col-2"></div> 
                        <div class="input-group col-7">
                            <asp:CheckBox ID="chkDeleteProject" Text=". ลบไฟล์เอกสารแนบ" runat="server" class="custom-control custom-control-inline  pl-0" AutoPostBack="true" />
                        </div>
                    </div>
                 </div>
            ...
            <div class="row" id="selectCustomerAssistant" runat="server">
                ...
                <div style="margin-top:30px;">
                    ...
                    <i class="fas fa-user-plus"></i> บันทึก</button>
                </div>
            </div>
            <div class="row">         
                <div class="col-md-12">
...
<%--                <Button runat="server" class="btn btn-success bg-mint" ID="Button2" onserverclick="Button2_Click">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-inline form-group form-row">
                        <p class="col-5">ค่าใช้จ่ายพิเศษ</p>
                ...
                <div class="col-md-5">
                    ...
                    <div class="form-inline form-row">
                        <p class="col-4">ค่าเลี้ยงรับรองลูกค้า</p>
                        <div class="input-group col-8">
    ...
    <script type="text/javascript">
        ...
        function datatable_casst() {
            ...
            var table = $('#table_tmpcasst').DataTable({
                ...
                { "width": "1%", "className": "text-center", "targets": 6 }
                ]
            });
        ...
        function delete_employee(id_value,qrs,re_id,re_qrs){
          if((user_permission == 'administrator1' && qrs == 'delete_tmpcasst') || qrs == 'delete_tmpct') { 
            ...
            bootbox.confirm({
                message: "ต้องการลบข้อมูลพนักงานรายนี้ใช่หรือไม่",
                buttons: {
                    confirm: {
                        label: 'ลบ',
        ...
        $('#button2').click(function(e) {
            ...
            if(check_data){
                ...
                $.ajax({
                    ...
                    error: function () {
                        bootbox.alert("function insert data error");
                ...
                bootbox.alert("กรุณากรอกข้อมูลให้ครบ ก่อนบันทึกข้อมูลพนักงาน")
            }
            //alert("test");
            return false;
        });
