<%@ Page Language="VB" MasterPageFile="~/MasterPageMenu.master" AutoEventWireup="false" CodeFile="edit_other.aspx.vb" Inherits="edit_other" %>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" GridLines="None"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="VAS &amp; Cost (per Month)">
                        <ItemTemplate>
                            <asp:TextBox ID="txtOtherName" runat="server" Text='<%# Bind("OTHER_Name")%>' CssClass="form-control"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
