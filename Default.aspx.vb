...
Partial Class _Default
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If DT.Rows.Count > 0 Then
            strSql = "insert into List_CAPEX (CAPEX_Name, Asset_Type, Cost, CreateBy, CreateDate) values('" + DT.Rows(0).Item("CAPEX_Name").ToString + "','" + DT.Rows(0).Item("Asset_Type").ToString + "','" + DT.Rows(0).Item("Equipment_Cost").ToString + "','" + Session("uemail") + "',getdate()) "
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If GridView1.Rows.Count > 0 Then
            ...
            Next
            For i = 0 To GridView1.Rows.Count - 1
                strSql = "Update List_CAPEX Set CAPEX_Name='" + GridView1.Rows(i).Cells(0).Text + "', Asset_Type='" + CType(GridView1.Rows(i).Cells(1).FindControl("ddlAssetType"), DropDownList).SelectedValue + "', Cost='" + Format(CDbl(CType(GridView1.Rows(i).Cells(2).FindControl("TextBox3"), TextBox).Text), "#0.00") + "', CreateBy='" + Session("uemail") + "', CreateDate = getdate() where id_List='" + CType(GridView1.Rows(i).Cells(3).FindControl("lblID"), Label).Text + "' "
                C.ExecuteNonQuery(strSql)
            Next
        End If
    ...
    Private Sub SetOAuthSingleSignOn(ByVal code As String)
        ...
        Dim URI As String = Replace(HttpContext.Current.Request.Url.GetLeftPart(UriPartial.Authority), "https", "http") & HttpContext.Current.Request.ApplicationPath & "/Default.aspx"
        ...
        Session("ufullname") = "คุณ" + DT.Rows(0).Item("thai_fullname")
        Session("uid") = DT.Rows(0).Item("employee_id")
    ...
    Public Sub SetLoginPermissionSession()
        Dim strSql As String
        Dim DT As New DataTable
