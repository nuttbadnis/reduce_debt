...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">            
        <input runat="server" type="hidden" id="token" />
        <div class="col-md-10 pull-right">    
            <!--<ol class="breadcrumb headingbar">
            <li class="breadcrumb-item active">Add Capex</li>
            ...
            <div class="col-md-10">
                           ...
                           <!-- <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" GridLines="None"
                            ...
                            <asp:Button ID="Button2" runat="server" Text="บันทึก" class="btn btn-success pull-right"/>-->
                            <br />
                            <br />
                &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
                <asp:Label ID="Label1" runat="server" Text="กรุณาเลือกรายการจากเมนูด้านข้าง" Font-Bold="True"></asp:Label>
