...
Partial Class Summary
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            txtDocumentDate.Value = Now.Day.ToString("00") + "/" + Now.Month.ToString("00") + "/" + Now.Year.ToString("0000")
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            Dim PreparedMail As String = lblPrepaireEmail.Text
    ...
    Protected Sub test_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles test.Click
        ...
        Session("startdate") = txtDocumentDate.Value
        Session("area") = ddlArea.SelectedValue
        Session("ref") = txtLocationName.Text
        Session("enddate") = txtServiceDate.Value
