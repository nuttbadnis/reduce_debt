...
Partial Class Summary_Upload
    ...
    Public Sub LoadPageCreate()
        ...
        If DT_ProjectName.Rows.Count > 0 Then
            ...
            Else
                ...
                ClientScript.RegisterStartupScript(Page.GetType, "success_update", "AlertNotification('โปรดแนบ Project File และบันทึกข้อมูล ในหน้า Project Overview ก่อน', function(){ window.location = 'project_name.aspx?menu=upload'; }); ", True)
            End If
        Else
            btnSave.Visible = False
            btnSaveToEditProject.Visible = False
            ...
            If (Session("Login_permission") = "administrator" Or (dt_check.Rows(0).Item("request_status").ToString = "55" And Session("Login_permission") = "inspector") Or (dt_check.Rows(0).Item("request_status").ToString = "110" And dt_check.Rows(0).Item("CreateBy").ToString = Session("uemail"))) Then
                ...
                If DT_ProjectName.Rows.Count > 0 Then
                    ...
                    Else
                        ...
                        btnSaveDraft.Visible = False
                        btnSaveToEditProject.Visible = False
                        ClientScript.RegisterStartupScript(Page.GetType, "success_update", "AlertNotification('โปรดแนบ Project File และบันทึกข้อมูลในหน้า Edit Project Overview ก่อน', function(){ window.location = 'edit_project_name.aspx?request_id=" & xRequest_id & "'; });", True)
                    End If
                Else
                    btnSave.Visible = False
                    btnSaveDraft.Visible = False
    ...
    Public Sub SaveCreateSummary(ByVal Command As String)
        ...
        If DT_ProjectName.Rows.Count <= 0 Then
            Dim pn_alert As String = "AlertNotification('กรุณากรอกข้อมูล Project Name',"
            ...
            '    Dim sv_alert as string = "AlertNotification('กรุณากรอกข้อมูล Service',"
        ...
        Else
            ...
            If Command = "SubmitApprove" Then
                ...
                Dim sm_alert As String = "AlertSuccess('บันทึกข้อมูลและส่งอนุมัติ สำเร็จ',"
    ...
    Public Sub SaveEditSummary(ByVal Command As String)
        ...
        If DT_ProjectName.Rows.Count <= 0 Then
            ClientScript.RegisterStartupScript(Page.GetType, "", "AlertNotification('กรุณากรอกข้อมูล Edit Project Name',function(){ focus();window.location.href='edit_project_name.aspx?request_id=" + xRequest_id + "'; });", True)
        ...
        Else
            ...
            If Command = "SubmitApprove" Then
                ...
                ClientScript.RegisterStartupScript(Page.GetType, "", "AlertSuccess('บันทึกข้อมูลและส่งอนุมัติ สำเร็จ',function(){ focus();window.location.href='check_status_list.aspx?menu=check'; });", True)
        ...
        Else
            ...
            Try
                ...
                Else
                    ...
                    ClientScript.RegisterStartupScript(Page.GetType, "success_insert", "AlertSuccess('บันทึกข้อมูลสำเร็จ', function(){ window.location = 'Summary_Upload.aspx?menu=upload'; });", True)
                End If
    ...
    Public Sub SaveDraftEditSummary()
        ...
        Else
            If DT_ProjectName.Rows(0).Item("project_File") = "" Then
                ClientScript.RegisterStartupScript(Page.GetType, "success_update", "AlertNotification('โปรดแนบ Project File และบันทึกข้อมูล ในหน้า Project Overview ก่อน', function(){ window.location = 'edit_project_name.aspx?request_id=" & xRequest_id & "'; });", True)
                Exit Sub
            End If
            ...
            Try
                If DT_Summary.Rows.Count > 0 Then
                    ...
                    ClientScript.RegisterStartupScript(Page.GetType, "success_update", "AlertSuccess('บันทึกข้อมูลล่าสุดสำเร็จ', function(){ window.location = 'Summary_Upload.aspx?request_id=" & xRequest_id & "'; });", True)
                Else
                    strSql = "Insert Into List_Summary (Document_No,Revenue,Revenue_Profit,OPEX,OPEX_Profit, " + vbCr
                    strSql += "MarketingPrice,MarketingPrice_Profit,EntertainPrice,EntertainPrice_Profit, " + vbCr
                    strSql += "GiftPrice,GiftPrice_Profit, " + vbCr
                    ...
                    ClientScript.RegisterStartupScript(Page.GetType, "success_insert", "AlertSuccess('บันทึกข้อมูลสำเร็จ', function(){ window.location = 'Summary_Upload.aspx?request_id=" & xRequest_id & "'; });", True)
                End If
            Catch ex As Exception
                ClientScript.RegisterStartupScript(Page.GetType, "failed_update", "AlertError('ไม่สามารถบันทึกข้อมูลได้');", True)
            End Try
    ...
    Protected Sub txtRevenue_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtRevenue.TextChanged
        ...
        Else
            txtRevenue.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ Revenue เป็นตัวเลขเท่านั้น!');", True)
            txtRevenue.Focus()
        End If
        CalculatePrice()
    End Sub
    ...
    '        ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ Revenue Profit เป็นตัวเลขเท่านั้น!');", True)
    ...
    Protected Sub txtMarketingCost_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMarketingCost.TextChanged
        ...
        Else
            txtMarketingCost.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ ต้นทุนทางการตลาด(Marketing Cost) เป็นตัวเลขเท่านั้น!');", True)
    ...
    '        ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ ต้นทุนทางการตลาด(Marketing Cost) Profit เป็นตัวเลขเท่านั้น!');", True)
    ...
    Protected Sub txtInternetCost_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtInternetCost.TextChanged
        ...
        Else
            txtInternetCost.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ ต้นทุน Internet Bandwidth เป็นตัวเลขเท่านั้น!');", True)
    ...
    Protected Sub txtNetworkCost_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtNetworkCost.TextChanged
        ...
        Else
            txtNetworkCost.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ ต้นทุน Network Bandwidth เป็นตัวเลขเท่านั้น!');", True)
    ...
    Protected Sub txtNOCCost_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtNOCCost.TextChanged
        ...
        Else
            txtNOCCost.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุต้นทุน O & M เป็นตัวเลขเท่านั้น!');", True)
            txtNOCCost.Focus()
        End If
        CalculatePrice()
    End Sub
    ...
    Protected Sub txtNOCCost_Profit_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtNOCCost_Profit.TextChanged
        ...
        Else
            txtNOCCost_Profit.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุต้นทุน O & M Profit เป็นตัวเลขเท่านั้น!');", True)
    ...
    Protected Sub txtJasmineGroupCost_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtJasmineGroupCost.TextChanged
        ...
        Else
            txtJasmineGroupCost.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ EXP. Jasmine Group เป็นตัวเลขเท่านั้น!');", True)
    ...
    Protected Sub txtOtherCost_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtOtherCost.TextChanged
        ...
        Else
            txtOtherCost.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ EXP. Other เป็นตัวเลขเท่านั้น!');", True)
            txtOtherCost.Focus()
        End If
        CalculatePrice()
    End Sub
    ...
    '        ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ EXP. Other Profit เป็นตัวเลขเท่านั้น!');", True)
    ...
    Protected Sub txtPenaltyCost_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPenaltyCost.TextChanged
        ...
        Else
            txtPenaltyCost.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ Penalty เป็นตัวเลขเท่านั้น!');", True)
    ...
    '        ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ Penalty Profit เป็นตัวเลขเท่านั้น!');", True)
    ...
    Protected Sub txtCAPEX_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCAPEX.TextChanged
        ...
        Else
            txtCAPEX.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ CAPEX เป็นตัวเลขเท่านั้น!');", True)
            txtCAPEX.Focus()
        End If
    ...
    Protected Sub lblCAPEX_Profit_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles lblCAPEX_Profit.TextChanged
        ...
        Else
            lblCAPEX_Profit.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ CAPEX Profit เป็นตัวเลขเท่านั้น!');", True)
    ...
    '    Else
    '        txtCashFlow.Text = "0"
    '        ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ Cash Flow เป็นตัวเลขเท่านั้น!');", True)
    '        txtCashFlow.Focus()
    '    End If
    'End Sub
    ...
    '        ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ Cash Flow Profit เป็นตัวเลขเท่านั้น!');", True)
    ...
    Protected Sub txtPayBack_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPayBack.TextChanged
        ...
        Else
            If txtPayBack.Text <> "<=1" Then
                txtPayBack.Text = "0"
                ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ Payback เป็นตัวเลข หรือ <=1 เท่านั้น!');", True)
                txtPayBack.Focus()
            End If
        End If
    End Sub
    ...
    Protected Sub txtPayBack_Profit_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPayBack_Profit.TextChanged
        ...
        Else
            If txtPayBack_Profit.Text <> "<=1" Then
                txtPayBack_Profit.Text = "0"
                ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ Payback Profit เป็นตัวเลข หรือ <=1 เท่านั้น!');", True)
    ...
    Protected Sub txtMargin_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMargin.TextChanged
        ...
        Else
            txtMargin.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ Margin เป็นตัวเลขเท่านั้น!');", True)
            txtMargin.Focus()
        End If
    End Sub
    ...
    Protected Sub txtMargin_Profit_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMargin_Profit.TextChanged
        ...
        Else
            txtMargin_Profit.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ Margin Profit เป็นตัวเลขเท่านั้น!');", True)
    ...
    Protected Sub txtNPV_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtNPV.TextChanged
        ...
        Else
            txtNPV.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ NPV เป็นตัวเลขเท่านั้น!');", True)
            txtNPV.Focus()
        End If
    End Sub
    ...
    Protected Sub txtNPV_Profit_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtNPV_Profit.TextChanged
        ...
        Else
            txtNPV_Profit.Text = "0"
            ClientScript.RegisterStartupScript(Page.GetType, "Alert", "AlertNotification('ระบุ NPV Profit เป็นตัวเลขเท่านั้น!');", True)
            txtNPV_Profit.Focus()
        End If
    End Sub
