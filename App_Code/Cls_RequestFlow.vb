...
#Region "loadUpdatePage"
    ...
    Public Function rLoadFlowBody_Detail(ByVal vRequest_id As String, ByVal vRequest_status As String, ByVal vRequest_step As String, Optional ByVal vReqeust_permiss As Integer = 0, Optional ByVal Full_flow As Integer = 0) As String
        ...
        For i As Integer = 0 To vDT.Rows().Count() - 1
            ...
            If vDT.Rows(i).Item("status_name") = "อนุมัติ" Then
                vLabel = "success"  'complete
                If vDT.Rows(i).Item("next_step") <> vDT.Rows(vDT.Rows.Count() - 1).Item("flow_step") Then
                    vStatusName = "ตรวจสอบแล้ว"
                End If
            ElseIf vDT.Rows(i).Item("status_name") = "แก้ไขข้อมูล" Then
                vLabel = "warning"
            ElseIf vDT.Rows(i).Item("status_name") = "ยกเลิก" Then
                vLabel = "danger"
            ElseIf vDT.Rows(i).Item("status_name") = "ไม่อนุมัติ" Then
                vLabel = "danger"
            ElseIf vDT.Rows(i).Item("status_name") = "รอข้อมูล" Then
                vLabel = "info"
            End If
            ...
            '    vTbody += "<td><a href='upload\" + vDT.Rows(i).Item("flow_file") + "' target='_blank'>ดูเอกสารสัญญา</a></td>"
            'Else
    ...
    Public Function rLoadFlowBody_Export(ByVal vRequest_id As String, ByVal vRequest_status As String, ByVal vRequest_step As String, Optional ByVal vReqeust_permiss As Integer = 0, Optional ByVal Full_flow As Integer = 0) As String
        ...
        For i As Integer = 0 To vDT.Rows().Count() - 1
            ...
            'If vDT.Rows(i).Item("flow_file") <> "" Then
            '    vTbody += "<td style='border-bottom:1px solid black;'><a href='upload\" + vDT.Rows(i).Item("flow_file") + "' target='_blank'>ดูเอกสารสัญญา</a></td>"
            'Else
        ...
        For i As Integer = 0 To vDT.Rows().Count() - 1
            ...
            And vDT.Rows(i).Item("uemail") Like "*" + Session("Uemail") + ";*")) Then
                ...
                If vDT.Rows(i).Item("add_next") = 1 Then
                    ...
                    vTbody += "    <div class='card-header card-fonting bg-mint text-light p-2'>แทรกลำดับถัดไป (Add Next) </div>"
                    ...
                    vTbody += "            </div>"
                    vTbody += "            <div class='form-group required-n'>"
                    vTbody += "                <label class='control-label'>ส่วนงาน</label>"
                    vTbody += "                <div class='col-sm-10'>"
                    vTbody += "                    <select id='sel_depart_id' class='form-control input-sm' >"
                    vTbody += "                         <option value=''>เลือกส่วนงาน</option>"
                ...
                vTbody += "<div class='card'>"
                vTbody += "    <div class='card-header card-fonting bg-mint bg-mint text-light p-2'><u><b>ฟอร์มอนุมัติพิจารณาโครงการ</b></u></div>"
                vTbody += "    <div class='card-body p-2'>"
                vTbody += "        <div class='form-horizontal'>"
                vTbody += "            <input id='flow_no' type='hidden' value='" & vDT.Rows(i).Item("flow_no") & "'>"
                vTbody += "            <input id='flow_sub' type='hidden' value='" & vDT.Rows(i).Item("flow_sub") & "'>"
                ...
                vTbody += "                <label class='col-sm-2 col-form-label'>สถานะ</label>"
                vTbody += "                <div class='col-sm-6 pl-0'>"
                If vDT.Rows(i).Item("depart_id") = "7" Then  'ถ้าเป็น President ให้เลือกเป็น Radio Button
                    vTbody += "                    <input id='rbtApprove' name='ap' value='50' type='radio' checked='checked' />อนุมัติ"
                    vTbody += "                    <input id='rbtNotApprove' name='ap' value='55' type='radio' />ไม่อนุมัติ"
                ...
                vTbody += "                <label class='col-sm-2 control-label pr-0'>หมายเหตุ</label>"
                vTbody += "                <div class='col-sm-10 pl-0'>"
                vTbody += "                    <textarea type='text' id='txt_flow_remark' class='form-control input-sm' rows='5' placeholder='กรอกหมายเหตุ..'></textarea>"
                vTbody += "                </div>"
                vTbody += "            </div>"
                ...
                If vDT.Rows(i).Item("depart_id") = "0" Then
                    vTbody += "            <div class='form-group row required-f'>"
                    vTbody += "                <label class='col-sm-3 control-label pr-0'>เอกสารสัญญา</label>"
                    vTbody += "                <div class='col-sm-9 pl-0'>"
                    vTbody += "                    <input id='flow_file' name='flow_file' type='file' class='form-control input-sm' />"
                    vTbody += "                </div>"
                    vTbody += "            </div>"
    ...
    Public Function rLoadStatusFormApprove(ByVal vRequest_id As String, ByVal vFlow_step As String, ByVal vApproval As String) As DataTable
        ...
        'vSql = "select status_id, case status_id when '55' then 'ยกเลิกโครงการ' else status_name end 'Status_name' "
        'Else
        vSql = "select status_id, status_name "
        'End If
        vSql += "from ( "
    ...
    Public Function CancelProject(ByVal user As String, ByVal vRequest_id As String, ByVal remark As String) As String
        ...
        Try
            ...
            If DT.Rows.Count > 0 Then
                ...
                Return "Complete"
            Else
                Return "ไม่สามารถ ยกเลิกโครงการ นี้ได้"
            End If
...
#Region "SendMail & Redirect"
    ...
    Public Sub SendMailSubmit(ByVal vCase As String, ByVal vRequest_id As String)
        ...
        Dim vCustomer_name As String = "" '"ลดหนี้กรณีชำระผิด Acc. โดยยอด APO และตัดบิลไปแล้ว  และมีการเพิ่มหนี้จากคุณ amornrat.ka เรียบร้อยแล้ว"
        Dim vSubject_name As String = "" '"ลดหนี้ชำระผิด Account"
        Dim vSubject_url As String = "" '"redebt555"
        Dim vProject_name As String = "" '"ลดหนี้"
        ...
        Select Case vCase
            Case "Open_Flow"
                'vMain_Point = "มีคำขอใหม่ รบกวนตรวจสอบคำขอเพื่อดำเนินการอนุมัติ"
                vMain_Point = "ขออนุมัติ"
                ...
                'vRequest_title = "ขออนุมัติ Feasibility เอกสารเลขที่ " + vRequest_id.ToString
                vSubject_name = "ขออนุมัติ Feasibility: " & vSubject_name
                vUemail = vDT.Rows(0).Item("send_uemail")
            Case "Cancle_Flow"
                'vMain_Point = "แจ้งคำขอถูกยกเลิก (ไม่อนุมัติ)"
                vMain_Point = "ไม่อนุมัติ"
                ...
                vDT = DB105.GetDataTable(sql)
                'vRequest_title = "ยกเลิก Feasibility เอกสารเลขที่ " + vRequest_id.ToString
                vSubject_name = "ยกเลิก Feasibility: " & vSubject_name
                vUemail = vDT.Rows(0).Item("send_uemail")

            Case "Back_Flow"
                'vMain_Point = "แจ้งคำขอ ไม่อนุมัติจากผู้บริหาร กรุณาตรวจสอบข้อมูลอีกครั้ง"
                vMain_Point = "ไม่อนุมัติจากผู้บริหาร"
                'vDT = loadDT_Cancle_Flow(vRequest_id)
                ...
                sql += "where rm.Document_No = '" + vRequest_id.ToString + "' "
                vDT = DB105.GetDataTable(sql)
                'vRequest_title = "คำขอไม่อนุมัติ Feasibility เอกสารเลขที่ " + vRequest_id.ToString
                vSubject_name = "คำขอไม่อนุมัติ Feasibility: " & vSubject_name
                vUemail = vDT.Rows(0).Item("send_uemail")
            Case "Next_Flow"
                'vMain_Point = "รบกวนตรวจสอบคำขอเพื่อดำเนินการอนุมัติ"
                vMain_Point = "ขออนุมัติ"
            ...
            Case "Reply_1"
                'vMain_Point = "คำขอต้องการให้แก้ไขข้อมูล กรุณาบันทึกแก้ไขข้อมูลภายใน7วัน ไม่เช่นนั้นคำขอจะถูกยกเลิก"
                vMain_Point = "ให้แก้ไข (ภายใน 7 วัน)"
                ...
                sql += "where Document_No = '" + vRequest_id.ToString + "' "
                vDT = DB105.GetDataTable(sql)
                'vRequest_title = "แก้ไขข้อมูล Feasibility เอกสารเลขที่ " + vRequest_id.ToString
                vSubject_name = "แก้ไขข้อมูล Feasibility: " & vSubject_name
                vUemail = vDT.Rows(0).Item("send_uemail")
            Case "Reply_2"
                'vMain_Point = "คำขอได้ดำเนินการแก้ไขข้อมูลเรียบร้อย โปรดตรวจสอบคำขอเพื่อดำเนินการอนุมัติต่อไป"
                vMain_Point = "ขออนุมัติ(แก้ไขแล้ว)"
                ...
                'vRequest_title = "แก้ไขข้อมูลเพิ่มเติม Feasibility เอกสารเลขที่ " + vRequest_id.ToString
                vSubject_name = "ขออนุมัติการแก้ไขข้อมูล Feasibility: " & vSubject_name
                vUemail = vDT.Rows(0).Item("send_uemail")

            Case "End_Flow"
                'vMain_Point = "ปิดคำขอเรียบร้อยแล้ว (จบกระบวนการ)"
                vMain_Point = "อนุมัติเรียบร้อยแล้ว"
                ...
                vDT = DB105.GetDataTable(strSql)
                'vRequest_title = "ปิดคำขอ Feasibility เอกสารเลขที่ " + vRequest_id.ToString
                vSubject_name = "ปิดคำขอ Feasibility: " & vSubject_name
                vUemail = vDT.Rows(0).Item("send_uemail")
        End Select
    ...
    Public Function rMailBody(ByVal vRequest_id As String, ByVal vCustomer_name As String, ByVal vSubject_name As String, ByVal vSubject_url As String, ByVal vProject_name As String, ByVal vMain_Point As String) As String
        ...
        "              <p><span style='font-family:tahoma;font-size: 14px;'><b>สถานะ:</b> </span><span style='font-family:tahoma;font-size: 14px;'>" + vMain_Point + "</span></p>" + _
        "              <p><span style='font-family:tahoma;font-size: 14px;'><b>เลขที่คำขอ:</b> </span><span style='font-family:tahoma;font-size: 14px;'>" + vRequest_id + "</span></p>" + _
        "              <p><span style='font-family:tahoma;font-size: 14px;'><b>ชื่อโครงการ:</b> </span><span style='font-family:tahoma;font-size: 14px;'>" + vProject_name + "</span></p>" + _
        "              <p><span style='font-family:tahoma;font-size: 14px;'><b>ชื่อลูกค้า:</b> </span><span style='font-family:tahoma;font-size: 14px;'>" + vCustomer_name + "</span></p>" + _
        "              <br/>" + _
        "              <p><a style='font-family:tahoma;font-size:14px;font-weight: bold;' href='" + herf_url + "'>คลิ๊กเพื่อดูรายละเอียด</a></p>" + _
        "              <p>--------------------------------------------------------------------------------</p>" + _
        "            </div>" + _
        "          </td>" + _
        "        </tr>" + _
        ...
        "            <p><span style='font-family:tahoma;font-size:12px;'>หากมีปัญหาการใช้งานโปรดติดต่อ: support_pos@jasmine.com</span></p>" + _
        "            <br>" + _
        "          </td>" + _
        "        </tr>" + _
        "      </table>" + _
