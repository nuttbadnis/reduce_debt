...
<!----Body ----------------->   
    ...
    <div class="col-md-12" id="dvMain" style="border: 1px solid black; padding-bottom: 15px; margin: 10px 0px 20px 0px;line-height: 17px;">
      ...
      <asp:HyperLink ID="LinkFileDoc" class="btn btn-danger" runat="server"><i class="fas fa-file-alt"></i> ไฟล์เอกสารแนบ</asp:HyperLink>
      <asp:Button ID="btnSave" runat="server" OnClientClick="return confirmDelete(this,'หลังจากส่งอนุมัติแล้ว ท่านจะไม่สามารถแก้ไขข้อมูลได้อีก <br />ต้องการส่งอนุมัติ หรือไม่');" class="btn btn-success float-right" Text="ส่งอนุมัติ" Visible="false" />
